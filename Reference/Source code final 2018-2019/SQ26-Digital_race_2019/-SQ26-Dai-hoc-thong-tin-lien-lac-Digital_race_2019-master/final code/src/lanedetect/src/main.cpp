...
void lane_Callback(const std_msgs::Float32::ConstPtr& msg){
     ...
     if ( l == 1 ) { DetectLane::phai = 1; DetectLane::trai = 0; tam1 =1;}
     if ( l == 2 ) {DetectLane::phai = 0; DetectLane::trai = 1; tam = 1;}
	//
     if ( tam == 1 ){
     	if ( l == 1 ){
		tam = 2;
		DetectLane::imgCount1 = 1;	
	}
     }
     if ( tam == 2 ){
	st = clock();
	tam = 3;
     ...
     if ( tam == 3){
	if ( (clock() - st)/100  > 200)
        DetectLane::imgCount1 = 0;
     }
	//
     if ( tam1 == 1 ){
     	if ( l == 2 ){
		tam1 = 2;
		DetectLane::imgCount1 = 2;	
	}
     }
     if ( tam1 == 2 ){
	st = clock();
