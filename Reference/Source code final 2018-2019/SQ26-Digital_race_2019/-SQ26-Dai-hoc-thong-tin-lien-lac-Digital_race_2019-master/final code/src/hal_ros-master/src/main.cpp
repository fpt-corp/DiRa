...
void set_led(const std_msgs::Bool::ConstPtr& msg)
{
	...
	else HAL.gpioSetValue(LED_PIN, false);
}
/*
void lcd_print(const std_msgs::String::ConstPtr& msg){
    ...
    cursor.x = 1; //atoi(array.at(0).c_str());
    cursor.y =  1;    //atoi(array.at(1).c_str());
...
void lcd_print_1(const std_msgs::String::ConstPtr& msg){
    std::string str;
    str = msg->data;
    string segment;
    vector<string> array;
    ...
    cursor.x = 1; //atoi(array.at(0).c_str());
    cursor.y =  2;    //atoi(array.at(1).c_str());
    int n = array.at(0).length(); 
    char char_array[n+1];
    strcpy(char_array, array.at(0).c_str());
    HAL.setCursor(cursor.x,cursor.y);
...
*/
void lcd_print_2(const std_msgs::String::ConstPtr& msg){
    std::string str;
    str = msg->data;
    string segment;
    vector<string> array;
    ...
    cursor.x = 1; //atoi(array.at(0).c_str());
    cursor.y =  0;    //atoi(array.at(1).c_str());
    int n = array.at(0).length(); 
    char char_array[n+1];
    strcpy(char_array, array.at(0).c_str());
    HAL.setCursor(cursor.x,cursor.y);
...
/*
void lcd_print_3(const std_msgs::String::ConstPtr& msg){
    std::string str;
    str = msg->data;
    string segment;
    vector<string> array;
    ...
    cursor.x = 1; //atoi(array.at(0).c_str());
    cursor.y =  3;    //atoi(array.at(1).c_str());
    int n = array.at(0).length(); 
    char char_array[n+1];
    strcpy(char_array, array.at(0).c_str());
    HAL.setCursor(cursor.x,cursor.y);
...
int main(int argc, char **argv)
{
    ...
    *sub = sb.subscribe("lcd_print_2", 10, lcd_print_2);
    //ros::Subscriber sub3 = sb1.subscribe("lcd_print_1", 10, lcd_print_1);
    //ros::Subscriber sub4 = sb2.subscribe("lcd_print_2", 10, lcd_print_2);
    //ros::Subscriber sub5 = sb3.subscribe("lcd_print_3", 10, lcd_print_3);
