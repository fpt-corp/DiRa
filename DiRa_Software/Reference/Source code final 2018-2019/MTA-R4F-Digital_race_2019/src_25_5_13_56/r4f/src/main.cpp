...
{   
    ...
    *sub = sb.subscribe("lcd_print", 10, lcd_print);
    ...
    ros::Subscriber sub3 = n.subscribe("/set_speed_car_api", 10, set_speed_car);
    ros::Subscriber sub4 = m.subscribe("/set_steer_car_api", 10, set_steer_car);
    ros::Subscriber sub5 = l.subscribe("/set_pos_camera_api", 10, set_pos_camera);
