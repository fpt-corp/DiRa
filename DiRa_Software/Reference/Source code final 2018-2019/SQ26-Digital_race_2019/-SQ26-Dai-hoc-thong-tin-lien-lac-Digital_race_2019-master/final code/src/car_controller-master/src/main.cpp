...
void car_speed(const std_msgs::Float32::ConstPtr& msg){
    double toc_do = msg->data;
    
    double speed = 10*toc_do;
    api_set_FORWARD_control(pca9685, speed);
    cout<<"toc_do"<<speed<<endl;
    if ( speed == 0) a = 0;
    else a = 1;
}
...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber sub4 = k.subscribe("/set_speed", 10, car_speed);
