...
// get distance
double getDistance(double rssi, int txPower, int n) {
    /*
     ...
     */
    double distance = pow(10, ((double) txPower - rssi) / (10 * 2));
...
int main(int argc, char **argv){
    ...
    node_obj.advertise<beacon_rssi::beacon>("beacon",10);
	beacon_rssi::beacon msg;
