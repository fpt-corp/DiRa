...
class AutoEncoder:
    def __init__(self, path=None, roi=0.5):
        """
        Initiate class
        :param path: path of road segmentation model
        :param roi: float number in range of [0, 1], represents the percentage of image height where ROI (region of interest) will be applied.
